...
@interface CompanyDetialController ()<UIScrollViewDelegate,UIViewControllerTransitioningDelegate>
...
- (void)setupSubViews
{
    self.titleArray = @[@"企业基本信息",@"企业联系信息",@"企业产品列表"];
    /** 初始化顶部标签滚动栏 */
...
{
    CompanyBasicController *vc = [self.childViewControllers firstObject];
...
- (void)addController
{
    CompanyBasicController * vc1 = [[CompanyBasicController alloc] init];
    vc1.model = self.model;
    [self addChildViewController:vc1];
    
    CompanyContactController * vc2 = [[CompanyContactController alloc] init];
    vc2.model = self.model;
    [self addChildViewController:vc2];
    
    CompanyProductsController * vc3 = [CompanyProductsController new];
...
- (void)scrollViewDidEndScrollingAnimation:(UIScrollView *)scrollView
{
    ...
    // 添加控制器
    if (index == 0) {
        CompanyBasicController *newsVc = self.childViewControllers[index];
        ...
        CompanyContactController *newsVc = self.childViewControllers[index];
        ...
        CompanyProductsController *newsVc = self.childViewControllers[index];
